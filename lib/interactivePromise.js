...
module.exports = function(asyncApis) {
  ...
  function schedule(fn, self) {
    ...
    if (!cycle) { // I should probably find a way to wait for drain to be finished
  ...
  function resolve(msg) {
    var _then, self = this;
    self.promise.__MSG__ = msg.value ? msg.value : msg;
    // already triggered?
  ...
  async function InteractivePromise(executor, wrapped=false) {
...
//module.exports = InteractivePromise;