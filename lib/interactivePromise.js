...
//async function Promise(executor) {
async function InteractivePromise(executor) {
  ...
  this["then"] = function then(success, failure) {
    ...
    let newP = Object.create(this.constructor.prototype);
    let result = this.constructor.call(newP, function extractChain(resolve, reject) {
